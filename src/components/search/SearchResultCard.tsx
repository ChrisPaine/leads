    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <a
          ...
          className="font-bold text-base text-blue-600 dark:text-blue-400 underline hover:text-blue-800 dark:hover:text-blue-300 transition-colors line-clamp-2 block"
          onClick={(e) => e.stopPropagation()}
        >
